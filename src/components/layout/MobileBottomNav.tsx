...
export const MobileBottomNav: React.FC = () => {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-background/90 backdrop-blur-lg border-t-2 border-white/10 pb-safe"
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {isActive && (
                  <div
                    className="absolute -top-1 -right-1 w-1.5 h-1.5 bg-primary rounded-none shadow-[var(--shadow-glow-sm)]"
                    aria-hidden="true"
                  />
                )}
              </div>
