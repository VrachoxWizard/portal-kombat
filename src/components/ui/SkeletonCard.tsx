...
export const SkeletonCard: React.FC = () => {
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-white/5 bg-[#0c0f1c]/45 backdrop-blur-md h-full">
...
export const SkeletonHero: React.FC = () => {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[#0c0f1c]/45 border border-white/5 min-h-[540px] flex items-end p-8 sm:p-12 w-full">
