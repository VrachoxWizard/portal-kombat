...
export default function CmsEditArticlePage({ params }: PageProps) {
  ...
  const fetchInitialData = React.useCallback(async () => {
    ...
    try {
      ...
      if (post.prediction) {
        setFighterA(post.prediction.fighterA || "");
        setFighterB(post.prediction.fighterB || "");
        setWinner(post.prediction.winner || "");
        setMethod(post.prediction.method || "");
        setPredictedRound(post.prediction.predictedRound || "");
